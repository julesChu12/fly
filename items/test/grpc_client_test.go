...
func main() {
	...
	fmt.Println("🚀 Connected to gRPC server on localhost:50056")
...
func testCreateItem(ctx context.Context, client itemsv1.ItemServiceClient) bool {
	req := &itemsv1.CreateItemRequest{
		...
		Duration:    &itemsv1.Int32Value{Value: 60},
		StaffRequired: &itemsv1.BoolValue{Value: true},
		Capacity:    &itemsv1.Int32Value{Value: 1},
	}
